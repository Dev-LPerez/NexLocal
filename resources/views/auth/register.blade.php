<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            <x-input-label for="role" value="Quiero registrarme como:" />
            <select name="role" id="role" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                <option value="tourist">Turista (Quiero vivir experiencias)</option>
                <option value="guide">Guía (Quiero ofrecer experiencias)</option>
            </select>
        ...
        <div class="mt-4">
            ...
            <input id="profile_photo" name="profile_photo" type="file" accept="image/*" class="block mt-1 w-full" required />
