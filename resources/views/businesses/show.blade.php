<x-app-layout>
    @php
        ...
        $banner = $business->banner_image_path ? asset('storage/' . $business->banner_image_path) : 'https://placehold.co/1200x400/e2e8f0/64748b?text=' . urlencode($business->name);
        $avatar = $business->cover_image_path ? asset('storage/' . $business->cover_image_path) : 'https://placehold.co/150x150/ffffff/7c3aed?text=' . substr(urlencode($business->name), 0, 1);
    @endphp
